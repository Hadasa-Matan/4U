...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white pb-12" dir="rtl" style={fontRegular}>
      ...
      {/* --- HERO SECTION --- */}
      {/* pt-20 דואג שהטקסט יתחיל בדיוק מתחת ל-Navbar בלי רווח מיותר */}
          ...
          <div className="bg-white rounded-[32px] shadow-xl shadow-slate-200/40 border border-slate-100 overflow-hidden relative">
            ...
            <div className="p-8 md:p-12 space-y-8 text-sm md:text-base text-slate-700 leading-relaxed text-right">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-50 p-6 rounded-2xl border-r-4 shadow-sm" style={{ borderColor: BRAND_BLUE }}>
                  <h3 className="text-slate-900 text-lg mb-2 font-bold" style={fontBold}>כבודקת תוכנה (QA)</h3>
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border-r-4 shadow-sm" style={{ borderColor: BRAND_GREEN }}>
              ...
              <div className="pt-8 border-t border-slate-50 text-center">
                <p className="text-lg md:text-xl font-bold" style={{ color: BRAND_BLUE }}>
