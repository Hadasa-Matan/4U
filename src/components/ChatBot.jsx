    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        <div className="bg-gray-100 rounded-lg p-3 mb-4 max-w-[80%]">
          היי, הבוט שלנו נמצא כרגע בשלבי פיתוח מתקדמים, ואנו עובדים במרץ כדי להעניק לך את השירות הטוב והמקצועי ביותר. בימים הקרובים נשיק את הגרסה המלאה שתוכל לסייע לך באופן מיטבי. נשמח לעמוד לרשותך בהקדם האפשרי ומעריכים את סבלנותך. אם יש לך שאלה דחופה, אנא צור איתנו קשר באחד מאמצעי התקשורת.
        </div>
      </div>
