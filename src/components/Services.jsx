...
function Services() {
  const featuredService = {
    ...
    title: "שקטבוטים™ — צ׳אטבוטים חכמים שמביאים שקט תפעולי",
    description:
    ...
    <section id="services" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center text-slate-600">
          רוצה שנבחר יחד את הפתרון שיביא <span className="font-bold" style={{ color: BRAND_BLUE }}>שקט, רוגע ושליטה</span> לעסק/לארגון?
        </div>
      </div>
    </section>
  );
